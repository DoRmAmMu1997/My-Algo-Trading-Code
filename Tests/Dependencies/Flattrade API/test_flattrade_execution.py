...
# The adapter and its diagnostic import each other by bare name, so the SOURCE
# folder -- not this test folder -- goes on sys.path.
# Tests/Dependencies/Flattrade API/<this file> -> repository root is three up.
sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "Dependencies" / "Flattrade API"))
