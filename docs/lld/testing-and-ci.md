...
| Tier | Floor | Modules |
|---|---|---|
| Repository floor | **73%** | everything (CI measures **73.8%** since PR #181 made CI run the SL Hunting worker tests; original MAT-110 baseline was 54.7%) |
...
- coverage config stays branch-enabled at the 73% floor;
